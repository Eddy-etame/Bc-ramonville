/* Banc d'essai d'Otto, l'assistant de Ramonville — playbook Anthropic, applique a notre prompt.
 *
...
/* Ramonville n'a pas de chatbot-kb.ts : ses cles de boutons vivent dans
   public/assets/js/chatbot.js, dans la table ACTIONS que lit resolveActions. */
const kb = readFileSync(join(RACINE, "public/assets/js/chatbot.js"), "utf8");
